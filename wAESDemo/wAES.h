...
public:
	...
	char * decrypt(char *coded, int cLen, char *key);
...
private:
	...
	void convertArrayToStr(int pArray[4][4], char *str);
...
private:
	int m_Rcon[10] = { 0x01000000, 0x02000000,
	...
	int m_colM[4][4] = { 
			...
			{ 3, 1, 1, 2 } };
	// sBox
	int m_S[16][16] = { { 0x63, 0x7c, 0x77, 0x7b, 0xf2, 0x6b, 0x6f, 0xc5, 0x30, 0x01, 0x67, 0x2b, 0xfe, 0xd7, 0xab, 0x76 },
	...
	// decrypt Sbox
	int m_deS[16][16] = { { 0x52, 0x09, 0x6a, 0xd5, 0x30, 0x36, 0xa5, 0x38, 0xbf, 0x40, 0xa3, 0x9e, 0x81, 0xf3, 0xd7, 0xfb },
